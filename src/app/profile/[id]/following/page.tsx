        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white">
              {profileData.full_name} Mengikuti
            </h1>
            <p className="text-gray-600 dark:text-gray-400 mt-2">
              {filteredFollowing.length} mengikuti
            </p>
          </div>
        ...
        {filteredFollowing.length === 0 ? (
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-12 text-center">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              {searchQuery.trim()
                ? "Tidak ditemukan yang sesuai dengan pencarian."
                : `${profileData.full_name} belum mengikuti penulis lain.`}
            </p>
            {searchQuery.trim() && (
              <button
                ...
                <div className="flex items-center space-x-4">
                  ...
                  >
                    {follow.profiles.avatar_url ? (
                      ...
                      <div className="w-16 h-16 bg-gradient-to-r from-indigo-500 to-purple-500 rounded-full flex items-center justify-center text-white font-bold text-xl">
                        {follow.profiles.full_name.charAt(0)}
                      </div>
                    )}
                  </Link>
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">
                      Diikuti sejak {formatDate(follow.created_at)}
                    </p>
                  </div>
